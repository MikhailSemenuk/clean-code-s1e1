...
var taskInput=document.querySelector(".task-add__field");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.querySelector(".task-list--current");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.classList.add("task__button-delete__img");
